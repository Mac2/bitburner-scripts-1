import { log, getConfiguration, instanceCount, getNsDataThroughFile, scanAllServers, formatMoney, formatRam, reservedMoney } from './helpers.js'
...
export async function main(ns) {
    ...
    do {
        absReservedMoney = options['absolute-reserve'] != null ? options['absolute-reserve'] : await reservedMoney(ns);
