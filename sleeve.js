import { log, getConfiguration, instanceCount, disableLogs, getActiveSourceFiles, getNsDataThroughFile, runCommand, formatMoney, formatDuration, reservedMoney } from './helpers.js'
...
async function mainLoop(ns) {
    ...
    let globalReserve = await reservedMoney(ns);
